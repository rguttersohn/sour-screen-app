...
class SimpleBackup
{
    ...
    {
        $this->config['compress'] = $compression;
    ...
    public function downloadAfterExport($export_name = '')
    {
        ...
        /* Seahorse Patch */
        if (isset($this->config['compress']) && 'Gzip' === $this->config['compress']) {
            $export_name .= '.gz';
        }
        /* End: Seahorse Patch */
    ...
    public function includeOnly($tables = [])
    {
        ...
        /**
         * Patch Added - 29/01/2020
         * P.Cullen
         * Override "static" function call to allow work for Object
         */
