                    ...
                    <div style="max-width:25%;" class="welcome-panel-column  welcome-panel-first">
                       ...
                       <p>
                        <?php echo sprintf(
                            ...
                            wpm2awsHtmlLink(
                                __(
                                    'https://aws.amazon.com/getting-started/hands-on/migrating-a-wp-website/?sc_icampaign=engage_lightsail-seahorse-tutorial_20200903&sc_ichannel=ha&sc_icontent=awssm-5645&sc_iplace=ribbon&trk=ha_awssm-5645',
                                    'migration-2-aws'
                                ),
                                __(
                                    'Click Here',
                        ...
                        echo sprintf(
                            esc_html(
                                __(
                                    'View Seahorse Demo videos %1$s.',
                                    'migration-2-aws'
                                )
                            ),
                            wpm2awsHtmlLink(
                                __(
                                    'https://www.seahorse-data.com/demo/',
                                    'migration-2-aws'
                                ),
                                __(
                                    'Here',
