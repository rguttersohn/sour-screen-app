    ...
    public static function awsRegions()
    {
        ...
        $template = array(
            array(
                ...
                'field_label' =>__('Select', 'migrate-2-aws'),
                'field_data' => $regions,
    ...
    public static function createS3Bucket()
    {
        $template = array(
            array(
                ...
                'field_placeholder' => __('Name your S3 Bucket', 'migrate-2-aws'),
                'field_label' =>__('S3 Bucket Name', 'migrate-2-aws'),
    ...
    public static function useExistingS3Bucket()
    {
        $template = array(
            array(
                ...
                'field_placeholder' => __('Select S3 Bucket', 'migrate-2-aws'),
                'field_label' =>__('Select S3 Bucket', 'migrate-2-aws'),
