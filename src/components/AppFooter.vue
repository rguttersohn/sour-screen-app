...
class="flex flex-col justify-between md:flex-row bg-blue-xLight p-10">
    ...
    class="w-full md:w-2/4">
        ...
        <router-link :to="{name:'CreateAccount'}">Or create an account</router-link>
        <form 
        ...
        >
            <input class="m-2 p-2" type="text" placeholder="User Name">
            <input class="m-2 p-2" type="password" placeholder="Password">
